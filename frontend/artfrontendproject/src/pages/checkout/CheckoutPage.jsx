...
// =======================================================
import { useCart } from '../../hooks/useCart'; // (Giả sử đường dẫn này đúng)
...
export default function CheckoutPage() {
  ...
  return (
    <>
      ...
      {/* (LoadingSpinner chỉ che phủ toàn bộ nếu isLoading, 
           isCheckingCoupon chỉ nên hiển thị 1 icon nhỏ) */}
      <LoadingSpinner isLoading={isLoading} />
      
      <div className="checkout-page">
        <h1 className="checkout-header">Thanh Toán</h1>
